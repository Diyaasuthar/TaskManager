      ...
      <div className='flex items-center justify-between px-4 py-3 md:px-6 max-w-7xl mx-auto'>
        ...
        <div className='flex items-center gap-4'>
            ...
            <div ref={menuref} className='relative'>
                <button onClick={handleToggleMenu} className='flex items-center gap-2 px-3 py-2 rounded-full cursor-pointer hover:bg-purple-50 transition-colors duration-300 border border-transparent hover:border-purple-200'>
                    <div className='relative '>
                        {user.avater ? (
                            <img src={user.avatar} alt="User Avatar" className='w-9 h-9 rounded-full' />
                        ) : (
                            <div className='w-8 h-8 flex items-center justify-center rounded-full bg-gradient-to-br from-fuchsia-500 via-purple-600 text-white font-semibold shadow-md'> 
