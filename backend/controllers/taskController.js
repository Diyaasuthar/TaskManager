...
// GET ALL TASKS FOR LOGED IN USER
export const getTasks = async (req,res) => {
   try {
        ...
        res.status(400).json({ success: false, message: 'Error fetching tasks', error: error.message });
   }
}
...
export const getTaskById = async (req, res) => {
    try {
        ...
        res.status(400).json({ success: false, message: 'Error fetching task', error: error.message });
    }
}
